...
RUN cd /home/jhipster && \
    wget https://github.com/jhipster/jhipster-sample-app/archive/v1.1.1.zip && \
    unzip v1.1.1.zip && \
    rm v1.1.1.zip
RUN cd /home/jhipster/jhipster-sample-app-1.1.1 && npm install
RUN cd /home && chown -R jhipster:jhipster /home/jhipster
RUN cd /home/jhipster/jhipster-sample-app-1.1.1 && sudo -u jhipster mvn dependency:go-offline
