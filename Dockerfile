...
RUN cd /home/jhipster && \
    wget https://github.com/jhipster/jhipster-sample-app/archive/v0.8.2.zip && \
    unzip v0.8.2.zip && \
    rm v0.8.2.zip
RUN cd /home/jhipster/jhipster-sample-app-0.8.2 && npm install
RUN cd /home && chown -R jhipster:jhipster /home/jhipster
RUN cd /home/jhipster/jhipster-sample-app-0.8.2 && sudo -u jhipster mvn dependency:go-offline
