...
RUN cd /home/jhipster && \
    wget https://github.com/jhipster/jhipster-sample-app/archive/v0.8.3.zip && \
    unzip v0.8.3.zip && \
    rm v0.8.3.zip
RUN cd /home/jhipster/jhipster-sample-app-0.8.3 && npm install
RUN cd /home && chown -R jhipster:jhipster /home/jhipster
RUN cd /home/jhipster/jhipster-sample-app-0.8.3 && sudo -u jhipster mvn dependency:go-offline
