...
RUN cd /home/jhipster && \
    wget https://github.com/jhipster/jhipster-sample-app/archive/v2.11.0.zip && \
    unzip v2.11.0.zip && \
    rm v2.11.0.zip
RUN cd /home/jhipster/jhipster-sample-app-2.11.0 && npm install
RUN cd /home && chown -R jhipster:jhipster /home/jhipster
RUN cd /home/jhipster/jhipster-sample-app-2.11.0 && sudo -u jhipster mvn dependency:go-offline
