...
RUN cd /home/jhipster && \
    wget https://github.com/jhipster/jhipster-sample-app/archive/v0.17.0.zip && \
    unzip v0.17.0.zip && \
    rm v0.17.0.zip
RUN cd /home/jhipster/jhipster-sample-app-0.17.0 && npm install
RUN cd /home && chown -R jhipster:jhipster /home/jhipster
RUN cd /home/jhipster/jhipster-sample-app-0.17.0 && sudo -u jhipster mvn dependency:go-offline
