...
RUN cd /home/jhipster && \
    wget https://github.com/jhipster/jhipster-sample-app/archive/v2.14.2.zip && \
    unzip v2.14.2.zip && \
    rm v2.14.2.zip
RUN cd /home/jhipster/jhipster-sample-app-2.14.2 && npm install
RUN cd /home && chown -R jhipster:jhipster /home/jhipster
RUN cd /home/jhipster/jhipster-sample-app-2.14.2 && sudo -u jhipster mvn dependency:go-offline
